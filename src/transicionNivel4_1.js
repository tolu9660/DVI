export default class Transicionnivel4_1 extends Phaser.Scene {
     ...
     */
    constructor() {
      super({ key: 'transicionnivel4_1' });
    }
  
    preload(){
      this.load.image('Transicionnivel4_1',"assets/sprites/TransicionNivel4C1.jpg");
    }
    /**
    ...
    create() {
      ...
      const backgroundImage=this.add.image(0,0,'Transicionnivel4_1').setOrigin(0,0);
