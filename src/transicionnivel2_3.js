export default class Transicionnivel2_3 extends Phaser.Scene {
    /**
     * Constructor de la escena
     */
    constructor() {
      super({ key: 'transicionnivel2_3' });
    }
  
    preload(){
      this.load.image('Transicionnivel2_3',"assets/sprites/TransicionNivel2C2.jpg");
    }
    /**
    ...
    create() {
      ...
      const backgroundImage=this.add.image(0,0,'Transicionnivel2_3').setOrigin(0,0);
