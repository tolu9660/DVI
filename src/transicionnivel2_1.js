export default class Transicionnivel2_1 extends Phaser.Scene {
    /**
     * Constructor de la escena
     */
    constructor() {
      super({ key: 'transicionnivel2_1' });
    }
  
    preload(){
      this.load.image('Transicionnivel2_1',"assets/sprites/TransicionNivel2C1.jpg");
    }
    /**
    ...
    create() {
      ...
      const backgroundImage=this.add.image(0,0,'Transicionnivel2_1').setOrigin(0,0);
      ...
      this.input.keyboard.on('keydown', function (event) { 
        ...
        this.scene.start('transicionnivel2_2')
      }, this);
